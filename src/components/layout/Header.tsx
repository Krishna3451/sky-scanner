...
const navItems = [
    ...
    { label: "Hotels", icon: Bed, active: false },
...
export default function Header() {
    ...
    return (
        <header className="relative z-50 bg-[#05203c] py-4">
                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="hidden md:flex items-center gap-1">
                            <button className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-white/90 hover:bg-white/10 transition-colors text-sm">
                                <HelpCircle className="w-5 h-5" />
                                <span>Help</span>
                            </button>
                            <button className="p-2 rounded-full text-white/90 hover:bg-white/10 transition-colors">
                                <Heart className="w-5 h-5" />
                            </button>
                            <button className="p-2 rounded-full text-white/90 hover:bg-white/10 transition-colors">
                                <User className="w-5 h-5" />
                            </button>
                            <button className="ml-2 flex items-center gap-2 px-4 py-2 rounded-lg text-white text-sm font-medium border border-white/30 hover:bg-white/10 transition-colors">
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all ${item.active
                                    ...
                                    : "bg-[#1a4166] text-white hover:bg-[#2a5176]"
                                    }`}
                            >
            ...
            {/* Mobile Menu */}
            {isMobileMenuOpen && (
                <div className="md:hidden bg-[#05203c] border-t border-white/10">
                    <div className="px-4 py-4 space-y-2">
                        {navItems.map((item) => {
                            ...
                            return (
                                <button
                                    key={item.label}
                                    className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm font-medium ${item.active
                                        ? "bg-[#0770e3] text-white"
                                        : "bg-[#1a4166] text-white hover:bg-[#2a5176]"
                                        }`}
                                >
                        ...
                        <div className="pt-4 border-t border-white/10 flex items-center gap-4">
                            ...
                            <button className="flex-1 py-2 rounded-lg text-white text-sm font-medium border border-white/30 hover:bg-white/10">
                                Log in
                            </button>
                        </div>
                    </div>
